...
test("I can search Google", async () => {
  // For this line you'll need to put the name of the search bar which you can find by
  //inspecting that element in Chrome
  let searchBar = await driver.findElement(By.name("q"));

  // This time you'll just finish this string with something you want to search on Google,
  //make sure you leanve that \n !
  await searchBar.sendKeys("FUNduro\n");
  ...
  await searchBar.sendKeys("Frienduro\n");
